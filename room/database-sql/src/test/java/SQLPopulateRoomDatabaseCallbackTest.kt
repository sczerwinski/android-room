...
@DisplayName("Tests for SQLPopulateRoomDatabaseCallback")
class SQLPopulateRoomDatabaseCallbackTest {
    ...
    @Test
    @DisplayName(
        value = "GIVEN SQLPopulateRoomDatabaseCallback with SQLScriptExecutor, " +
            "WHEN onCreate, " +
    ...
    fun onCreate() {
        ...
        val sqlExecutor = SQLScriptExecutor.Builder()
            .addScript(sqlScript)
            .build()
        val callback = SQLPopulateRoomDatabaseCallback(sqlExecutor)
